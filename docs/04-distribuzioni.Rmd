...
Il valore atteso, indicato con $E(X)$, o $\mu$ è la **media** dei valori della variabile aleatoria $X$ (ovvero, la somma di prodotti tra i valori che può assumere e le corrispondenti probabilità)
